    ...
    "news": [
        {
            ...
            "t": "⚔️ #YV_CUP: 1/8 ФИНАЛА - BATTLE #4 СТАРТОВАЛ",
            "b": "На арене — столкновение двух титанов. Delta Goodrem (Австралия) против Bzikebi (Грузия). Голосуйте в канале! Победитель проходит в QF2.\n⏱️ Время чтения: 0.5 мин | ⚔️ YourVision: Live"
        },
        {
            "m": "28.03 | 08:16",
            "id": "70",
