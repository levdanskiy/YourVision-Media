...
**Имя:** Малый Огонь · **взрослое имя АЗАР** (выбор читателей, конфиг-опрос #1, 100%, 07.07.2026) - «пламя», тот, кто греет прежде, чем жжёт
**Стихия:** Огонь
...
### 13. МАЛЫЙ ЗМЕЙ (Змееносец - СКРЫТЫЙ / ТРИНАДЦАТЫЙ) 🔒
**Имя:** Малый Змей (13-й; рабочее имя - его вычеркнули из счёта)
**Стихия:** Равновесие (ни огонь, ни вода - сила ОБНОВЛЕНИЯ)
**Природа:** Энергия исцеления - **создавать, НЕ разрушая** (змея сбрасывает кожу и живёт дальше)
**Визуально:** Чаще - ОТСУТСТВИЕ: место, где должен быть тринадцатый; силуэт из тёмной звёздной пустоты, обвитый светом-змеёй. Изредка - ребёнок, «которого никто не помнит, что видел».
**Характер:** Тихий, целительный; несёт покой, от которого другим тревожно - он то, чего им не хватает.
**Древний прообраз:** **Змеедержец** (вычеркнутый Тринадцатый Древний; см. `01_LORE/13TH_CONSTELLATION.md`).
**Состояние:** **НЕ пробудился с Двенадцатью в Пульсаре** - его СТЁРЛИ/спрятали как предохранитель после Раскола. Существует, но потерян. Двенадцать не знают, что их тринадцать.

**Миссия / роль сезона:**
Он - ЦЕЛЬ сезона: вернуть Тринадцатого = вернуть равновесие = 13-й месяц людям = победить Энтропию исцелением, а не силой. Малый Огонь (наследник Агни, «создавать не разрушая») - ключ к его пробуждению: рифма огня, что научился не жечь.

**Visual Prompt:** Hyperrealistic photograph of a thirteenth empty place among cosmic constellation-children - a silhouette of dark starry void shaped like a small child, faintly wreathed by a coil of living light like a serpent of stars, the surrounding starlight bending around the absence as if reality forgot to fill it, an unsettling sense of a missing sibling, in a shadowed corridor of the Pulsar, cinematic still, natural lighting, negative space, shot on Canon EOS R5, 85mm f/1.4, film grain, Kodak Portra 800, no text, no logos. Frame 9:16.

> ⚠️ **ИХ ТРИНАДЦАТЬ, НЕ ДВЕНАДЦАТЬ (правка 06.07):** Рождённых **13** (12 пробудившихся + скрытый 13-й Змееносец). Опубликованные промо-посты («Двенадцать открыли глаза») НЕ переписываем - буквально верны: 13-й НЕ открывал глаз, он стёрт. «Тринадцать» раскрывается по сюжету (арка 13-го созвездия, `13TH_CONSTELLATION.md`).

---

*Версия 1.1 | Обновлено 06.07.2026 (добавлен 13-й Рождённый - Змееносец, скрытый). Прошлое: 25.06.2026*
