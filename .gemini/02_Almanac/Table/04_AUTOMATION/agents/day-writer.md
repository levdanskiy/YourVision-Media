...
- From `2026-07-23`, all three AL files are recipe-only: food rubrics, quantified `ИНГРЕДИЕНТЫ`, numbered `ПРИГОТОВЛЕНИЕ`, and cultural/source context only as recipe headnote. Standalone non-recipe material routes to Almanac: Calendar (`/home/levdanskiy/.gemini/05_Almanac: Calendar`).
