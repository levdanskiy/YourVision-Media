...
This is the durable decision log for user-approved rules. Detailed implementation lives in the Bibles; this file records what changed and when.

| Effective | Decision | Operational consequence |
|-----------|----------|-------------------------|
| Current | Global scope with no default city, country or region | Geography stays when it proves origin, comparison, source, ecology, language or calendar difference. |
| Current | Three main posts per day | Do not create a fourth daily `AL`. |
| `2026-07-07` | Expanded rubrics and modern post shapes | Use PERSONAE/BESTIARY/OBJECTS and wider food/calendar taxonomies. |
| `2026-07-07` | `15:04` is food-only | Move standalone PROSE/ETYMON elsewhere. |
| `2026-07-17` | Main slots become `09:04 / 15:04 / 21:04` | Keep legacy times through `2026-07-16`; do not rewrite them for timing alone. |
| `2026-07-17` | Bolder contemporary voice and visuals | Prefer dossier, field file, lab note, table map and evidence board; visuals resemble current magazine shoots. |
...
| `2026-07-23` | Non-recipe material routes to Almanac: Calendar | Standalone myth, folklore, calendar, divination, oracle, source, etymology, omen and ritual posts move to `https://t.me/AlmanacCalendar` (`/home/levdanskiy/.gemini/05_Almanac: Calendar`). |
...
| `2026-07-23` | Channel pivots to recipe-only | Every daily `AL` is a reproducible recipe; old myth/calendar/divination/source rubrics may appear only as food context in Almanac, while standalone versions belong to Almanac: Calendar. |
