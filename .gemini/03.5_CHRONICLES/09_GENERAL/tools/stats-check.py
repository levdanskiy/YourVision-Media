#!/usr/bin/env python3
"""
stats-check.py - валидатор числовых счётчиков дерева BLACK BOX (Chronicles).
...
Использование:
    ...
    python3 stats-check.py parallax --quiet  # только ошибки/предупреждения
"""
...
TREE = "CHRONICLES"
TREE_ROOT = Path("/home/levdanskiy/.gemini/03.5_CHRONICLES")

# Код работы -> папка проекта
WORKS = {
    "tower": "01_TOWER",
    "parallax": "02_PARALLAX",
    "somnium": "03_SOMNIUM",
}
