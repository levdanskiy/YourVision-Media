...
PROJECTS = {
    ...
    "zodiac":   ("04_LITERATURE/02_ZODIAC",  ["Малый Огонь","Малая Луна","Малый Шторм","Малый Ветер","Малая Капля","Малый Луч","Малая Травинка","Малый Правдивец","Малый Шип","Малая Стрела","Малый Камень","Малый Ветерок","Малый Океан","Малое Небо","Малый Змей"]),
